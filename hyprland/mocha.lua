...
-- Colors are exposed as globals so other modules can reference them.
-- Two variants per colour: rgb() string (for borders etc.) and raw hex
-- (for contexts that need the alpha-less hex, e.g. "rgba(hexHex + alpha)").
